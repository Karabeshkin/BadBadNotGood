  ...
  async up(queryInterface) {
    await queryInterface.bulkInsert("Questions", [
      ...
      },
      {
        themeId: 3,
        question:
          "Какой силой обладает девочка с зелеными волосами Тацумаки из аниме «Ванпанчмен»?",
        answer: "Телекинез",
        score_points: 100,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        themeId: 3,
        question:
          "Как зовут полковника армии Аместриса и огненного алхимика из аниме «Стальной алхимик»?",
        answer: "Рой Мустанг",
        score_points: 200,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        themeId: 3,
        question:
          "Назовите имя старосты класса 1-А из аниме «Моя геройская академия»?",
        answer: "Тенья Иида",
        score_points: 300,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      {
        themeId: 3,
        question: "В каком из аниме демон – родная сестра главного героя?",
        answer: "Клинок, рассекающий демонов",
        score_points: 500,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        themeId: 3,
        question:
          "Что скрывает Иноке Хашибира под маской кабана («Клинок, рассекающий демонов»)?",
        answer: "Женоподобное лицо",
        score_points: 1000,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
